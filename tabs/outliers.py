...
def render(df: pd.DataFrame):
    ...
    st.markdown("To prevent aggressive removal, outliers will only be removed from a column below a certain "
    "threshold (currently 200) or any outliers in price, since price is the main feature of interest for my analysis. " \
